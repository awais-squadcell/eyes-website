function Footer() {
  return (
    <div className="w-full flex h-screen bg-zinc-900 p-20 font-['Test_Founders_Grotesk_X-Cond SmBd']">
      <div className="w-1/2 h-full flex flex-col justify-between">
        <div className="headings">
        <h1 className="text-[6vw] uppercase leading-none -mb-4 font-bold ">Eye</h1>
        <h1 className="text-[6vw] uppercase leading-none -mb-4 font-bold ">opening</h1>
        </div>
      ...
      <h1 className="text-[6vw] uppercase leading-none -mb-4 font-bold ">Presentations</h1>
        <div className="w-full h-full font-['Neue_Montreal'] py-20 flex flex-col gap-10 text-base">
            <div>
                ...
                <a className="block hover:underline" href="#">Linkdln</a>
            </div>
            <div className="flex justify-between">
                <div>
                <h1 className="pb-2">Address</h1>
                    <a className="block hover:underline pb-2" href="#">202-1965 W 4th Ave <br />Vancouver, Canada</a>
                    <a className="block hover:underline" href="#">30 Chukarina St <br />Lviv, Ukraine</a>
                </div>
                <div>
                <h1 className="pb-2">Web Links</h1>
                    <a className="block hover:underline" href="#">Home</a>
                    <a className="block hover:underline" href="#">Services</a>
                    <a className="block hover:underline" href="#">Our Work</a>
                    <a className="block hover:underline" href="#">About Us</a>
                    <a className="block hover:underline" href="#">Insights</a>
